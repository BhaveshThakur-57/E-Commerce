    ...
    >
      <div className="relative overflow-hidden aspect-[3/4] bg-zinc-50 dark:bg-zinc-800">
        ...
        <div className="absolute top-3 right-3 flex flex-col gap-2 translate-x-10 group-hover:translate-x-0 transition-transform duration-300">
          <button
            ...
            className={`w-9 h-9 rounded-full flex items-center justify-center shadow-lg transition-all ${
              liked ? "bg-brand-500 text-white" : "bg-white dark:bg-zinc-800 text-zinc-600 hover:text-brand-500"
            }`}
          >
        ...
        <div className="absolute bottom-4 left-4 right-4 translate-y-10 group-hover:translate-y-0 transition-transform duration-300">
          ...
          >
            <ShoppingBag size={14} />
            {loading ? "Adding..." : added ? "Added!" : product.stock === 0 ? "Sold Out" : "Add to Cart"}
          </button>
        </div>
      </div>
