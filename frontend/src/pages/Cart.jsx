        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {items.map((item) => (
              <div
                key={item.product}
                className="flex gap-4 p-4 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800"
              >
                <img
                  src={item.image}
                  alt={item.name}
                  ...
                  onError={(e) => {
                    e.target.src = `https://picsum.photos/seed/${item.product}/100/130`;
                  }}
                />
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-full border border-zinc-200 dark:border-zinc-700 flex items-center justify-center hover:border-brand-400 hover:text-brand-500 transition-colors disabled:opacity-40"
                    >
                      <Plus size={13} />
                    </button>
