    ...
    <main className="min-h-screen pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-3xl p-8 sm:p-12 border border-zinc-100 dark:border-zinc-800 shadow-xl shadow-brand-500/5 animate-fade-up">
          ...
          <h1 className="font-display text-4xl sm:text-5xl font-bold mb-6">Terms & Conditions</h1>
          <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-10">Our terms of service and usage.</p>
          
          <div className="prose dark:prose-invert max-w-none space-y-6 text-zinc-700 dark:text-zinc-300">
            <p>Welcome to the Terms & Conditions page for LUXORA. We are committed to providing you with the best experience.</p>
